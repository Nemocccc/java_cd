...
<div class="x-nav">
    ...
    <a class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right;background-color: #393D49"
       href="/findDormClean" title="刷新">
        <i class="layui-icon" style="line-height:30px;color: white">ဂ</i>
    </a>
</div>
<div class="x-body">
    <!-- 搜索区域 -->
    <div class="search-container">
        <form class="layui-form" action="/findDormClean">
            <div class="search-row">
                ...
                <div class="search-field" style="max-width: 120px;">
                    <button class="layui-btn" lay-submit="" lay-filter="sreach" style="width: 100%;background-color: #393D49">
    ...
    <div class="layui-row" id="test" style="display: none;">
        <div class="modal-content">
            <div class="modal-title">添加宿舍卫生记录</div>
                ...
                <div class="layui-form-item">
                    <div class="layui-input-block">
                        <button type="button" class="layui-btn layui-btn-normal"
                                style="background: linear-gradient(to bottom, #e3f2fd, #bbdefb); color: #1565c0;"
    ...
    <table class="layui-table">
        ...
        <c:forEach items="${di.list}" var="di">
            <tr>
                ...
                <td>
                    <a title="编辑" class="action-btn edit-btn" href="/findDormCleanById?g_id=${di.g_id}">
